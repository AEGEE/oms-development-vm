...
/usr/bin/ldapadd -x -D "cn=admin,dc=aegee,dc=org" -w aegee -f /var/opt/aegee/10-structure.ldif -c 
/usr/bin/ldapadd -x -D "cn=admin,dc=aegee,dc=org" -w aegee -f /var/opt/aegee/11-antennae.ldif -c 
